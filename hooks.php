 ...
 * 
 * @package KsfFA_ksf_FA_CampaignBuilder
 * @version 2.4.3
 */

define('SS_ksf_FA_CampaignBuilder', 126 << 8);
...
class hooks_ksf_FA_CampaignBuilder extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_CampaignBuilder_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_CampaignBuilder] = _("");
        $security_areas['SA_ksf_FA_CampaignBuilderVIEW'] = array(
            SS_ksf_FA_CampaignBuilder | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_CampaignBuilderMANAGE'] = array(
            SS_ksf_FA_CampaignBuilder | 2, 
            _("Manage ")
        );
